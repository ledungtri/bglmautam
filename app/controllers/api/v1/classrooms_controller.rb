...
module Api
  module V1
    class ClassroomsController < BaseController
      ...
      def enrollments
        render_collection @classroom.enrollments.includes(:grades, :attendances, :evaluation).sort_by(&:sort_param)
      end

      # GET /api/v1/classrooms/:id/teaching_assignments
      def teaching_assignments
        render_collection @classroom.teaching_assignments.includes(:attendances).sort_by(&:sort_param)
      end
