...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { cell_id: @attendance.cell_id, result: @attendance.result, student_id: @attendance.student_id }
    end
  ...
  test "should update attendance" do
    patch :update, id: @attendance, attendance: { cell_id: @attendance.cell_id, result: @attendance.result, student_id: @attendance.student_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
