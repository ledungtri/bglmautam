...
class InstructionsControllerTest < ActionController::TestCase
  ...
  test "should create instruction" do
    assert_difference('Instruction.count') do
      post :create, instruction: { cell_id: @instruction.cell_id, position: @instruction.position, teacher_id: @instruction.teacher_id }
    end
  ...
  test "should update instruction" do
    patch :update, id: @instruction, instruction: { cell_id: @instruction.cell_id, position: @instruction.position, teacher_id: @instruction.teacher_id }
    assert_redirected_to instruction_path(assigns(:instruction))
  end
